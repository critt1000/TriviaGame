...
// //Load the question
//     //Need to change image src to current question
//     //Need to load buttons with possible answers
//     //Need to add one to currentQuestion
// function loadQuestion () {
//     $("#imageQuestion").attr("src", question[currentQuestion].src);
//     currentQuestion += 1;
//     fillButtons();
// };


// //Creates the buttons of possible answers
//     //Need to go through question.answers
// function fillButtons () {
//     for (var i = 0; i < question.answers.length; i++) {
//         switch(i) {
//             case 0:
//             $("#q1").empty();
//             $("#q1").text(question[currentQuestion].answers[0]);
//             break;

//             case 1:
//             $("#q2").empty();
//             $("#q2").text(question[currentQuestion].answers[1]);
//             break;

//             case 2:
//             $("#q3").empty();
//             $("#q3").text(question[currentQuestion].answers[2]);
//             break;

//             case 3:
//             $("#q4").empty();
//             $("#q4").text(question[currentQuestion].answers[3]);
//         };
//     };
// };
