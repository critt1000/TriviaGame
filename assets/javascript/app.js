...
function nextQuestion() {
    ...
    if (questionCounter < 21) {
        ...
        $("#a1").attr("value", answer1[questionCounter]);
        $("#label1").html(answer1[questionCounter]);
        $("#label2").html(answer2[questionCounter]);
        $("#label3").html(answer3[questionCounter]);
        $("#label4").html(answer4[questionCounter]);
        questionCounter++;
    } else {
        // call win function
    }
